...
if st.button("Gerar Diagnóstico"):
    if not nome_paciente or not genero or not idade or not altura or not peso or not familia or not transporte:
        ...
        # Envio dos dados SEM Peso e Altura para casar com a feature selection de treinamento
        dados = pd.DataFrame([{
        ...
        # Obter classe final e as probabilidades de cada classe
        ...
        # Criação de DataFrame para o gráfico
