...
if st.button("Realizar Previsão"):
    # 1. Mapas de conversão (Frontend visual -> Backend numérico esperado pelo modelo)
    ...
    # 3. Montagem do dicionário (Garantindo que o nome 'Tempo_Exercicio' bata com o treinamento)
    dados_entrada = {
        'Genero': genero, 
        'Idade': float(idade), 
        'Altura': float(altura), 
